Feature: Manage officers
  As an administrator
  I want to be able to manage officer information
  So I can assign officers to investigations and balance workloads

  Background:
    Given an initial setup
  
  # READ METHODS
  Scenario: No officers yet
    Given no setup yet
    When I go to the officers page
    And I should see "There are no active officers at this time"
    And I should not see "Name"
    And I should not see "Rank"
  ...
  Scenario: View all officers (paginated)
    When I go to the officers page
